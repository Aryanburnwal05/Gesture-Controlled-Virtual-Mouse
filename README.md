...
# Getting Started
  ...
  ### Procedure
  ```bash
  git clone https://github.com/Aryanburnwal05/Gesture-Controlled-Virtual-Mouse.git
  ```
...
# Collaborators
  | |  |  |  |  |
  | ------------- | ------------- | ------------- | ------------- | ------------- |
  | Aryan Burnwal | [GitHub](https://github.com/Aryanburnwal05) | [Email](mailto:burnwalaryan922@gmail.com) | LinkedIn | Instagram |
